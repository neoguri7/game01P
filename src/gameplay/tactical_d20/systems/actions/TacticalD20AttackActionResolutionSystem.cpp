...
#include "gameplay/tactical_d20/events/FTacticalD20DamageEvents.h"
#include "gameplay/tactical_d20/logging/FTacticalD20LogUtils.h"
#include "gameplay/tactical_d20/rules/FTacticalD20Random.h"
#include "gameplay/tactical_d20/rules/FTacticalD20RollPolicy.h"
...
void PublishDamageEvent(entt::registry& registry, entt::entity attacker, entt::entity target, const FTacticalD20DamageApplicationResult& applied) {
    ...
    PublishAndQueueFrameEvent(registry, damageEvent);
