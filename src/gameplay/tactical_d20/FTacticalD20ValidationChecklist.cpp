...
constexpr FSeedItem ChecklistSeeds[] = {
    ...
    {"edge.melee_adjacency", "Edge Cases", "Melee target not adjacent rejects.", ETacticalD20ChecklistStatus::Hooked, "Command validation reason hook."},
    ...
    {"edge.burning_defeat_skip", "Edge Cases", "Unit defeated by Burning at turn start skips action and advances turn.", ETacticalD20ChecklistStatus::Hooked, "Damage and lifecycle event hooks."},
    {"edge.stunned_skip", "Edge Cases", "Stunned unit starts turn, logs skip, consumes turn, and decays condition.", ETacticalD20ChecklistStatus::Hooked, "Condition tick hook."},
    {"edge.dodge_multi_attack", "Edge Cases", "Dodge persists disadvantage across multiple incoming attacks before expiration.", ETacticalD20ChecklistStatus::Hooked, "Focused repeated AttackResolved disadvantage hook."},
